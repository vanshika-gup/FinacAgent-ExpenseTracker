...
class OperationsAsyncClient:
    ...
    async def list_operations(self, name, filter_, retry=..., timeout=..., compression=..., metadata=...):
        """
    ...
    async def cancel_operation(self, name, retry=..., timeout=..., compression=..., metadata=...):
    ...
    async def delete_operation(self, name, retry=..., timeout=..., compression=..., metadata=...):
