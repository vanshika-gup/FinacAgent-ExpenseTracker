...
class PermissionServiceAsyncClient:
    ...
    async def create_permission(self, request: Optional[Union[permission_service.CreatePermissionRequest, dict]] = ..., *, parent: Optional[str] = ..., permission: Optional[gag_permission.Permission] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, str]] = ...) -> gag_permission.Permission:
    ...
    async def get_permission(self, request: Optional[Union[permission_service.GetPermissionRequest, dict]] = ..., *, name: Optional[str] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, str]] = ...) -> permission.Permission:
    ...
    async def list_permissions(self, request: Optional[Union[permission_service.ListPermissionsRequest, dict]] = ..., *, parent: Optional[str] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, str]] = ...) -> pagers.ListPermissionsAsyncPager:
    ...
    async def update_permission(self, request: Optional[Union[permission_service.UpdatePermissionRequest, dict]] = ..., *, permission: Optional[gag_permission.Permission] = ..., update_mask: Optional[field_mask_pb2.FieldMask] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, str]] = ...) -> gag_permission.Permission:
    ...
    async def delete_permission(self, request: Optional[Union[permission_service.DeletePermissionRequest, dict]] = ..., *, name: Optional[str] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, str]] = ...) -> None:
    ...
    async def transfer_ownership(self, request: Optional[Union[permission_service.TransferOwnershipRequest, dict]] = ..., *, retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, str]] = ...) -> permission_service.TransferOwnershipResponse:
