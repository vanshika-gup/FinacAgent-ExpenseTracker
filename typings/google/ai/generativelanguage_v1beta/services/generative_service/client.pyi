...
class GenerativeServiceClient(metaclass=GenerativeServiceClientMeta):
    ...
    def generate_content(self, request: Optional[Union[generative_service.GenerateContentRequest, dict]] = ..., *, model: Optional[str] = ..., contents: Optional[MutableSequence[content.Content]] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, str]] = ...) -> generative_service.GenerateContentResponse:
    ...
    def generate_answer(self, request: Optional[Union[generative_service.GenerateAnswerRequest, dict]] = ..., *, model: Optional[str] = ..., contents: Optional[MutableSequence[content.Content]] = ..., safety_settings: Optional[MutableSequence[safety.SafetySetting]] = ..., answer_style: Optional[generative_service.GenerateAnswerRequest.AnswerStyle] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, str]] = ...) -> generative_service.GenerateAnswerResponse:
    ...
    def embed_content(self, request: Optional[Union[generative_service.EmbedContentRequest, dict]] = ..., *, model: Optional[str] = ..., content: Optional[gag_content.Content] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, str]] = ...) -> generative_service.EmbedContentResponse:
    ...
    def batch_embed_contents(self, request: Optional[Union[generative_service.BatchEmbedContentsRequest, dict]] = ..., *, model: Optional[str] = ..., requests: Optional[MutableSequence[generative_service.EmbedContentRequest]] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, str]] = ...) -> generative_service.BatchEmbedContentsResponse:
    ...
    def count_tokens(self, request: Optional[Union[generative_service.CountTokensRequest, dict]] = ..., *, model: Optional[str] = ..., contents: Optional[MutableSequence[content.Content]] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, str]] = ...) -> generative_service.CountTokensResponse:
