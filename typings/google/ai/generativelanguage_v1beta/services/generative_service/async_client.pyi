...
class GenerativeServiceAsyncClient:
    ...
    async def generate_content(self, request: Optional[Union[generative_service.GenerateContentRequest, dict]] = ..., *, model: Optional[str] = ..., contents: Optional[MutableSequence[content.Content]] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, str]] = ...) -> generative_service.GenerateContentResponse:
    ...
    async def embed_content(self, request: Optional[Union[generative_service.EmbedContentRequest, dict]] = ..., *, model: Optional[str] = ..., content: Optional[gag_content.Content] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, str]] = ...) -> generative_service.EmbedContentResponse:
    ...
    async def count_tokens(self, request: Optional[Union[generative_service.CountTokensRequest, dict]] = ..., *, model: Optional[str] = ..., contents: Optional[MutableSequence[content.Content]] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, str]] = ...) -> generative_service.CountTokensResponse:
