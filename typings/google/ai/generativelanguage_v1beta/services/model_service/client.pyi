...
class ModelServiceClient(metaclass=ModelServiceClientMeta):
    ...
    def get_model(self, request: Optional[Union[model_service.GetModelRequest, dict]] = ..., *, name: Optional[str] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, str]] = ...) -> model.Model:
    ...
    def list_models(self, request: Optional[Union[model_service.ListModelsRequest, dict]] = ..., *, page_size: Optional[int] = ..., page_token: Optional[str] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, str]] = ...) -> pagers.ListModelsPager:
        r"""Lists the
    ...
    def get_tuned_model(self, request: Optional[Union[model_service.GetTunedModelRequest, dict]] = ..., *, name: Optional[str] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, str]] = ...) -> tuned_model.TunedModel:
    ...
    def list_tuned_models(self, request: Optional[Union[model_service.ListTunedModelsRequest, dict]] = ..., *, page_size: Optional[int] = ..., page_token: Optional[str] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, str]] = ...) -> pagers.ListTunedModelsPager:
    ...
    def create_tuned_model(self, request: Optional[Union[model_service.CreateTunedModelRequest, dict]] = ..., *, tuned_model: Optional[gag_tuned_model.TunedModel] = ..., tuned_model_id: Optional[str] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, str]] = ...) -> operation.Operation:
    ...
    def update_tuned_model(self, request: Optional[Union[model_service.UpdateTunedModelRequest, dict]] = ..., *, tuned_model: Optional[gag_tuned_model.TunedModel] = ..., update_mask: Optional[field_mask_pb2.FieldMask] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, str]] = ...) -> gag_tuned_model.TunedModel:
    ...
    def delete_tuned_model(self, request: Optional[Union[model_service.DeleteTunedModelRequest, dict]] = ..., *, name: Optional[str] = ..., retry: OptionalRetry = ..., timeout: Union[float, object] = ..., metadata: Sequence[Tuple[str, str]] = ...) -> None:
