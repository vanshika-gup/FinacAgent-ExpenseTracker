...
class Data(_BaseLayoutHierarchyType):
    ...
    def __init__(self, arg=..., barpolar=..., bar=..., box=..., candlestick=..., carpet=..., choroplethmapbox=..., choroplethmap=..., choropleth=..., cone=..., contourcarpet=..., contour=..., densitymapbox=..., densitymap=..., funnelarea=..., funnel=..., heatmapgl=..., heatmap=..., histogram2dcontour=..., histogram2d=..., histogram=..., icicle=..., image=..., indicator=..., isosurface=..., mesh3d=..., ohlc=..., parcats=..., parcoords=..., pie=..., pointcloud=..., sankey=..., scatter3d=..., scattercarpet=..., scattergeo=..., scattergl=..., scattermapbox=..., scattermap=..., scatterpolargl=..., scatterpolar=..., scatter=..., scattersmith=..., scatterternary=..., splom=..., streamtube=..., sunburst=..., surface=..., table=..., treemap=..., violin=..., volume=..., waterfall=..., **kwargs) -> None:
        """
