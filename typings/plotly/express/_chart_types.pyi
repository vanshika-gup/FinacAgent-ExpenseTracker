...
def scatter_map(data_frame=..., lat=..., lon=..., color=..., text=..., hover_name=..., hover_data=..., custom_data=..., size=..., animation_frame=..., animation_group=..., category_orders=..., labels=..., color_discrete_sequence=..., color_discrete_map=..., color_continuous_scale=..., range_color=..., color_continuous_midpoint=..., opacity=..., size_max=..., zoom=..., center=..., map_style=..., title=..., template=..., width=..., height=...) -> go.Figure:
    """
...
def choropleth_map(data_frame=..., geojson=..., featureidkey=..., locations=..., color=..., hover_name=..., hover_data=..., custom_data=..., animation_frame=..., animation_group=..., category_orders=..., labels=..., color_discrete_sequence=..., color_discrete_map=..., color_continuous_scale=..., range_color=..., color_continuous_midpoint=..., opacity=..., zoom=..., center=..., map_style=..., title=..., template=..., width=..., height=...) -> go.Figure:
    """
    In a choropleth map, each row of `data_frame` is represented by a
...
def density_map(data_frame=..., lat=..., lon=..., z=..., hover_name=..., hover_data=..., custom_data=..., animation_frame=..., animation_group=..., category_orders=..., labels=..., color_continuous_scale=..., range_color=..., color_continuous_midpoint=..., opacity=..., zoom=..., center=..., map_style=..., radius=..., title=..., template=..., width=..., height=...) -> go.Figure:
    """
...
def line_map(data_frame=..., lat=..., lon=..., color=..., text=..., hover_name=..., hover_data=..., custom_data=..., line_group=..., animation_frame=..., animation_group=..., category_orders=..., labels=..., color_discrete_sequence=..., color_discrete_map=..., zoom=..., center=..., map_style=..., title=..., template=..., width=..., height=...) -> go.Figure:
    """
